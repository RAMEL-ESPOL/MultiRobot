...
def generate_launch_description():
    ...
    # Create3 robot spawn command
    create3_spawn_cmd_7 = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(get_package_share_directory('irobot_create_gazebo_bringup'), 'launch', 'create3_spawn.launch.py')
        ),
        launch_arguments=[
    ...
    # Create3 robot spawn command
    create3_spawn_cmd_8 = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(get_package_share_directory('irobot_create_gazebo_bringup'), 'launch', 'create3_spawn.launch.py')
        ),
        launch_arguments=[
    ...
    # Create3 robot spawn command
    create3_spawn_cmd_9 = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(get_package_share_directory('irobot_create_gazebo_bringup'), 'launch', 'create3_spawn.launch.py')
        ),
        launch_arguments=[
    ...
    # Create3 robot spawn command
    create3_spawn_cmd_10 = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(get_package_share_directory('irobot_create_gazebo_bringup'), 'launch', 'create3_spawn.launch.py')
        ),
        launch_arguments=[
    ...
    delay_create7 = TimerAction(
        period=160.0,
        actions=[create3_spawn_cmd_7],
    )
    delay_create8 = TimerAction(
        period=190.0,
        actions=[create3_spawn_cmd_8],
    )
    delay_create9 = TimerAction(
        period=220.0,
        actions=[create3_spawn_cmd_9],
    )
    delay_create10 = TimerAction(
        period=250.0,
        actions=[create3_spawn_cmd_10],
    )
    ...
    #ld.add_action(delay_create7)
    #ld.add_action(delay_create8)
    #ld.add_action(delay_create9)
    #ld.add_action(delay_create10)
    return ld
