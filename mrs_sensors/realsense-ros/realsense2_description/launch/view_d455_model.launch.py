...
def generate_launch_description():
    ...
    # Robot Description
    robot_description_cmd = f"$(find xacro)/xacro --inorder '{get_package_share_directory('realsense2_description')}/urdf/test_d455_camera.urdf.xacro' use_nominal_extrinsics:=true"
